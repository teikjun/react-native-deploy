      ...
      <Layout>
        <div className="pageContainer HelpPage">
          <div className="container margin-vert--lg">
            ...
            <h3>Repository</h3>
            <p>
              The core of <strong>React Native</strong> is worked on full-time
            ...
            <p>
              ...
              Native conferences{' '}
              <a href="http://www.awesome-react-native.com/#conferences">
                here
              </a>
              {'.'}
            </p>
