...
<img
  src="./assets/input-accessory-2.gif"
  style="float:left; padding-right: 70px; padding-top: 20px"
/>
...
<img
  src="./assets/input-accessory-3.gif"
  style="float:left; padding-right: 70px; padding-top: 20px"
/>
...
<img
  src="./assets/input-accessory-4.gif"
  style="float:left; padding-right: 70px; padding-top: 20px"
/>
...
<img
  src="./assets/input-accessory-5.gif"
  style="float:left; padding-right: 70px; padding-top: 20px"
/>
