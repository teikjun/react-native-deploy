...
![source of the `metro.config.js` file in the 0.59 template, demonstrating where to enable `inlineRequires`](./assets/inline-requires.png)
...
![0.58's CLI is slow to start](./assets/0.58-cli-speed.png)![0.58's CLI is nearly instantaneous](./assets/0.59-cli-speed.png)
